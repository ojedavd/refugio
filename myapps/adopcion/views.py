...
from myapps.adopcion.models import Persona, Solicitud
from myapps.adopcion.forms import PersonaForm, SolicitudForm
# Create your views here.

def index_adopcion(request):
    return HttpResponse("soy el index de adopcion")
